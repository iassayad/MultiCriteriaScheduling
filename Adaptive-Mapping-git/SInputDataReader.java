...
public class SInputDataReader {
   public static class SInputDataReaderException extends Exception {
      private static final long serialVersionUID = 1021L;
      SInputDataReaderException(String file) {
   ...
   public SInputDataReader(String fileName) throws IOException {
   ...
   double readDouble() throws SInputDataReaderException,
                              IOException {
      int ntType = _tokenizer.nextToken();
      
      if ( ntType != StreamTokenizer.TT_NUMBER )
         throw new SInputDataReaderException(_fileName);
      
      return _tokenizer.nval;
   }
     
   int readInt() throws SInputDataReaderException,
                        IOException {
      int ntType = _tokenizer.nextToken();
   ...
   double[] readDoubleArray() throws SInputDataReaderException,
                                     IOException {
 	int ntType;
     ...
     // if ( ntType != '[' )
      ...
      ntType = _tokenizer.nextToken();
       while (ntType == StreamTokenizer.TT_NUMBER || ntType == StreamTokenizer.TT_WORD ) {
		if (ntType == StreamTokenizer.TT_NUMBER ){
   ...
   double[][] readDoubleArrayArray() throws SInputDataReaderException,
                                            IOException {
 	int ntType;
      //int ntType = _tokenizer.nextToken(); // Read the '['
      
      //if ( ntType != '[' )
       //  throw new InputDataReade	 int ntType;rException(_fileName);
   ...
   int[] readIntArray() throws SInputDataReaderException,
                               IOException {
      int ntType;
      //int ntType = _tokenizer.nextToken(); // Read the '['
   ...
   int[][] readIntArrayArray() throws SInputDataReaderException,
                                      IOException {
	 int ntType;
    //  int ntType = _tokenizer.nextToken(); // Read the '['
