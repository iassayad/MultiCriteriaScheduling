...
, application sammp, processor ourson type=U */
...
#define input2_o__ourson_y_empty 6
#define input2_o__ourson_y_full 5
#define add_o__louve_y_empty 4
#define add_o__louve_y_full 3
#define input1_o__ourson_y_empty 2
#define input1_o__ourson_y_full 1
...
{ #define NB_SENDERS_ 
  ...
  int recvs[] = {sd[0]};
  reliable_send(recvs, (char*)add_o, 1*sizeof(int));}
    Precede(add_o__louve_y_empty);
  }} /* end loop_2 */
