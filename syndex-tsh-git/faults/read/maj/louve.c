...
#define add_o__louve_y_empty 6
#define add_o__louve_y_full 5
#define input2_o__louve_y_empty 4
#define input2_o__louve_y_full 3
#define input1_o__louve_y_empty 2
#define input1_o__louve_y_full 1
